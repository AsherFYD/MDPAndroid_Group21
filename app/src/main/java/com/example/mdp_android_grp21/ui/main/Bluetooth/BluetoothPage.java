package com.example.mdp_android_grp21.ui.main.Bluetooth;
...
//                }
        ...
        localDeviceTextView = findViewById(R.id.localDeviceNameTextview);
        localDeviceTextView.setText("Device name: "+ getLocalBluetoothName());
    ...
    public void toggleButtonScan(View view){
        ...
        if(mBluetoothAdapter != null) {
            ...
            if (mBluetoothAdapter.isDiscovering()) {
                ...
                Log.d(TAG, "toggleButton: Starting Discovery.");
...
//                otherDevicesListView.setAdapter(mNewDevlceListAdapter);
    ...
    public String getLocalBluetoothName(){
        ...
        //if local device has no name, use the address
        if(name == null){
